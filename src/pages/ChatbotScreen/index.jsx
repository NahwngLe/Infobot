...
const ChatbotScreen = ({setFile, fileInputRef, handleUploadFile}) => {
    return (
        <>
            <div className="tiltle flex justify-center text-black w-[80%]">
                ...
                <div className="pdfText inline-block rounded-xl rotate-3 mt-[7%] ">
                    <h1
                        className='text-5xl font-bold p-3 bg-purple-500 text-white rounded-xl'
