            ...
            <div className="max-w-3xl w-full text-center space-y-8">
                ...
                <div className="space-y-6">
                    <div className="flex items-center justify-center space-x-4">
                        <FaRobot className="w-12 h-12 text-blue-500" />
                    ...
                    <p className="text-xl text-gray-400">
                        Upload your PDF and start an intelligent conversation about its contents
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
                    <div className="card">
                        ...
                        <p className="text-gray-400">Advanced AI understands your document's context</p>
                    </div>
                    <div className="card">
                        <h3 className="text-lg font-semibold mb-2">Quick Answers</h3>
                        <p className="text-gray-400">Get instant responses to your questions</p>
                    </div>
                    <div className="card">
                        <h3 className="text-lg font-semibold mb-2">Easy Sharing</h3>
                        <p className="text-gray-400">Share insights and collaborate with others</p>
                    </div>
                </div>
